# BITRE Edits
The following files have been edited for BITRE's implementation.
batch_mod.py is an altered version of the batch addition script, and barefoot.yaml is an addition
map/osm/tools/bfmap.py
config/australia.properties
config/server.properties
src/main/java/com/bmwcarit/barefoot/matcher/MatcherKState.java
src/main/java/com/bmwcarit/barefoot/roadmap/Route.java
src/main/java/com/bmwcarit/barefoot/roadmap/Road.java
src/main/java/com/bmwcarit/barefoot/road/BaseRoad.java

Collectively these changes are made to create a debug mode that returns
- the osm_id of the matched segment
- the osm_id of segments traversed to that segment
- the length of the traversed route between observations
- the imputed speed experienced on the route between observations
- the ASGS classification of the road
- the azimuth of the vehicle on the matched segment and the media azimuth for imputed segments

The changes also include car ferries and eliminate closed and private roads
