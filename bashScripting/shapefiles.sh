...
unzip ../shapefiles/sa2_2021.zip
unzip ../shapefiles/ste_2021.zip
rm ../shapefiles/*.zip
##geojson files for broken geopandas


echo "If using ABS shapefiles remove null geometries"
ogr2ogr -f Geojson ../shapefiles/SA2_2021_AUST.geojson ../shapefiles/SA2_2021_AUST_SHP_GDA2020.shp
ogr2ogr -f Geojson ../shapefiles/STE_2021_AUST.geojson ../shapefiles/STE_2021_AUST_SHP_GDA2020.shp
